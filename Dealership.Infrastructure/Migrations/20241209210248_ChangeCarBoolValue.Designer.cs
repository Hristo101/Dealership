...
namespace Dealership.Infrastructure.Migrations
{
    ...
    [Migration("20241209210248_ChangeCarBoolValue")]
    partial class ChangeCarBoolValue
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dealership.Infrastructure.Data.Models.Announcement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CarId = 1,
                            CreatedDate = new DateTime(2024, 12, 9, 23, 2, 47, 687, DateTimeKind.Local).AddTicks(7999),
                        ...
                        new
                        {
                            Id = 2,
                            CarId = 2,
                            CreatedDate = new DateTime(2024, 12, 9, 23, 2, 47, 687, DateTimeKind.Local).AddTicks(8084),
                        ...
                        new
                        {
                            Id = 3,
                            CarId = 3,
                            CreatedDate = new DateTime(2024, 12, 9, 23, 2, 47, 687, DateTimeKind.Local).AddTicks(8088),
                        ...
                        new
                        {
                            Id = 4,
                            CarId = 4,
                            CreatedDate = new DateTime(2024, 12, 9, 23, 2, 47, 687, DateTimeKind.Local).AddTicks(8091),
                        ...
                        new
                        {
                            Id = 5,
                            CarId = 5,
                            CreatedDate = new DateTime(2024, 12, 9, 23, 2, 47, 687, DateTimeKind.Local).AddTicks(8093),
                        ...
                        new
                        {
                            Id = 6,
                            CarId = 6,
                            CreatedDate = new DateTime(2024, 12, 9, 23, 2, 47, 687, DateTimeKind.Local).AddTicks(8098),
                        ...
                        new
                        {
                            Id = 7,
                            CarId = 7,
                            CreatedDate = new DateTime(2024, 12, 9, 23, 2, 47, 687, DateTimeKind.Local).AddTicks(8100),
